  ...
  const helpMenu = (
    <Menu className="custom-dropdown">
      <Menu.ItemGroup
        ...
        title={
          <span>
            Info <DownOutlined style={{ fontSize: "10px", marginLeft: "5px", color: "#19c6c7" }} />
          </span>
        }
      >
        <Menu.Item key="about">
      ...
      <Menu.ItemGroup
        ...
        title={
          <span>
            Documentation <DownOutlined style={{ fontSize: "10px", marginLeft: "5px", color: "#19c6c7" }} />
          </span>
        }
      >
            ...
            <>
              ...
              <div style={menuItemStyle}>
                <Dropdown overlay={helpMenu} trigger={["hover"]}>
                  ...
                  >
                    Help
                    <CaretDownFilled style={{ fontSize: "12px", marginLeft: "5px" }} />
                  </Button>
                </Dropdown>
              </div>
            </>
