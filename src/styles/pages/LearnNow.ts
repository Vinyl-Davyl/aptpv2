  ...
  :is(a) {
    ...
    &:hover {
      background-color: ${(props) =>
        props.theme.bgColor === "#0a1a2f" ? "rgba(255, 255, 255, 0.05)" : "rgba(0, 0, 0, 0.03)"};
    ...
    &.active {
      background-color: ${(props) =>
        props.theme.bgColor === "#0a1a2f" ? "rgba(25, 198, 199, 0.15)" : "rgba(25, 198, 199, 0.1)"};
...
export const NavLinkContent = styled.div`
  ...
  svg {
    color: ${(props) => (props.theme.bgColor === "#0a1a2f" ? "rgba(214, 228, 255, 0.7)" : "rgba(5, 12, 64, 0.7)")};
  }
