        ...
        <SidebarContainer>
          ...
          <SidebarNav>
            ...
            <SidebarSection>
              ...
              <NavItem>
                <NavLink to="module1" className={({ isActive }) => (isActive ? "active" : "")}>
                  <NavLinkContent>
              ...
              <NavItem>
                <NavLink to="module2" className={({ isActive }) => (isActive ? "active" : "")}>
                  <NavLinkContent>
              ...
              <NavItem>
                <NavLink to="module3" className={({ isActive }) => (isActive ? "active" : "")}>
                  <NavLinkContent>
